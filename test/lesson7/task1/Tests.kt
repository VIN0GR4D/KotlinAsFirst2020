...
между                более               правой               парой               соседних               слов."""
        ...
        assertEquals(
            "Садовая 19-1-55", foo(
                "Пионерская 9-17: комната 18, комната 14, кухня 7, коридор 4" +
                        ...
                        "Железнодорожная 3-6: комната 21, кухня 6, коридор 4", "комната 19; комната 12"
            )
        )
    }
    ...
    fun foo1() {
        assertEquals(
            "Мерседес, 20, Феррари, 11, Макларен, 9, Ред Булл, 9", foo1(
                "Гран-при Австралии:\n" +
    ...
    fun exam() {
        assertEquals(
            "//начало ДИПЛОМА\n" +
                    "На сегодняшний день важность качества програмного обеспечения\n" +
                    "невозможно переоценить, так как оно используется в самых разных\n" +
                    "областях человеческой деятельности. /* Дабавить сылку!!! */", exam(
                "//НОЧАЛО ДИПЛОМА\n" +
                        "На сегодняшний день важность качиства програмного обиспечения\n" +
                        "НевозможноПереоценить, так как оно используется в самых разных\n" +
                        "областях человеческой деятельности. /* Дабавить сылку!!! */",
                "ночало -> начало\n" +
                        "качиства -> качества\n" +
                        "обиспечения -> обеспечения\n" +
                        "невозможнопереоценить -> невозможно переоценить"
            )
        )
    }
    ...
    fun exam1() {
        assertEquals(
            "0 Вступление\n" +
                ...
                "1 Первое действие\n" +
                        "3 Интерлюдия\n" +
                        "6 Последствие", listOf("2 Следующий акт", "5 Вторая глава", "8 Футбол", "0 Вступление")
            )
        )
    }
    ...
    fun segment() {
        assertEquals(
            ...
            lesson7.task1.segment("23:59", "00:01")
        )
        assertEquals("BC BC:BC BC, BC BC:BC ABDEG, BC BC:BC ABCDG", lesson7.task1.segment("11:11", "11:13"))
    }
}