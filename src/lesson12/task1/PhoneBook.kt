...
class PhoneBook {
    ...
    fun removePhone(name: String, phone: String): Boolean {
        ...
        if (phoneBook[name] == null) res = false
        if (phone !in phoneBook[name]!!) res = false
        if (res) phoneBook[name]!!.remove(phone)
        return res
    }
    ...
    fun phones(name: String): Set<String> {
        ...
        if (name in phoneBook.keys) res = phoneBook[name]!!.toMutableSet()
        return res
    }
    ...
    fun humanByPhone(phone: String): String? {
        var res = ""
        for (name in phoneBook.keys) if (phoneBook[name]!!.contains(phone)) res = name
